...
overlay         /etc       overlay   x-initrd.mount,x-systemd.requires=/,x-systemd.rw-only,lowerdir=/etc,upperdir=/sysroot/etc_overlay/upperdir,workdir=/sysroot/etc_overlay/workdir,index=off,metacopy=off,comment=etcoverlay    0   0
overlay         /var       overlay   x-initrd.mount,x-systemd.requires=/,x-systemd.rw-only,lowerdir=/var,upperdir=/sysroot/var_overlay/upperdir,workdir=/sysroot/var_overlay/workdir,index=off,metacopy=off,comment=varoverlay    0   0
" > /etc/fstab
