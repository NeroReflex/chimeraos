...
overlay         /etc       overlay   defaults,x-initrd.mount,x-systemd.rw-only,lowerdir=/etc,upperdir=/sysroot/etc_overlay/upperdir,workdir=/sysroot/etc_overlay/workdir,comment=etcoverlay    0   0
overlay         /var       overlay   defaults,x-initrd.mount,x-systemd.rw-only,lowerdir=/var,upperdir=/sysroot/var_overlay/upperdir,workdir=/sysroot/var_overlay/workdir,comment=varoverlay    0   0
" > /etc/fstab
